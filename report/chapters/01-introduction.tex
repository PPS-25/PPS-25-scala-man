...
closed maze, collect standard collectibles, and avoid enemies to complete the selected game mode. It
...
A paused game can be saved from the in-game menu and resumed later with its maze, positions, remaining collectibles,
...
optional extensions in the project proposal; all were completed and integrated into the final application.
