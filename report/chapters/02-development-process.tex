...
The following increments were concluded across the four sprints:

\begin{enumerate}
  \item The project foundation: build, automated checks, the core domain, and validated textual maps.
  \item The gameplay core: movement, collisions, lives, effects, enemy strategies, and scoring foundations.
  \item A playable ScalaFX application: rendering, menu, commands, saves, leaderboards, and game modes.
  \item The final delivery: Patroller integration, refinements, documentation, regression checks, and packaging.
\end{enumerate}
...
WartRemover complements formatting by checking production sources for selected unsafe constructs: partial
