...
with the code rather than after it. It counts \textbf{516 tests over 60 suites} and runs in under two seconds. Each
...
Map validation is the largest suite of the project: each rule listed under FR-S2 has a test that rejects a maze
...
Every requirement of Chapter 3 is answered by tests. The table names, for each one, the suites that establish it; the
non-functional requirements name their own evidence where they are stated.
