...
\begin{center}
  \begin{tabular}{|p{1.4cm}|p{2.4cm}|p{8cm}|}
    \hline
    \textbf{ID} & \textbf{Quality} & \textbf{Requirement and evidence} \\
    \hline
    NFR-P1 & Responsiveness & The average duration of a complete model update must remain below the 16 milliseconds a
    ...
    \hline
    NFR-R1 & Robustness & Malformed maps and saves must be rejected with an actionable explanation rather than crashing the
    ...
    \hline
    NFR-D1 & Determinism & A model update must depend only on its input state and elapsed time. The game rules can therefore
    be reproduced and tested independently of the graphical interface. \\
    \hline
    NFR-P2 & Portability & The application must run without source changes on systems providing JDK 21. The delivery workflow
    packages it as a self-contained executable JAR. \\
    \hline
    NFR-U1 & Usability & A new player must be able to choose a name, maze, and mode and start a game from the menu without
