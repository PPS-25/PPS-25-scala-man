...
\begin{itemize}
  ...
  \textbf{Survival} has no gathering objective and admits no victory at all: enemies become faster every thirty
  seconds, and the game ends only when the player runs out of lives.
...
\begin{center}
  \begin{tabular}{|p{3cm}|p{8.8cm}|}
    ...
    \texttt{TickPerformanceIT} integration test measures the average of 1,000 updates, after warm-up, on every
    supplied maze and requires it to remain below that threshold. \\
    \hline
